        ...
        <>
            <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
                ...
                <div className="flex justify-between my-5">
                    <button type="button" className="py-2 px-6 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold uppercase" onClick={() => setEdicion(paciente)}>Editar</button>
                    <button type="button" className="py-2 px-6 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold uppercase" onClick={() => eliminarPaciente(_id)}>Eliminar</button>
                </div>
